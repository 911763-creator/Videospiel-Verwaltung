...
public class VideospielGUI extends JFrame {
    ...
    protected ArrayList<Spiel> spieleListe;
    ...
    public VideospielGUI() {
        ...
        berechneButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double gerundet = Math.round(summe * 100.0) / 100.0;
                ausgabeArea.setText("Der Gesamtpreis aller Spiele ist: " + gerundet + "€");
            }
        });
    ...
    protected boolean enthaeltZahlen(String text) {
